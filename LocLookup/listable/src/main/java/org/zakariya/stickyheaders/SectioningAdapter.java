...
public class SectioningAdapter extends RecyclerView.Adapter<BasicViewHolder> {
    ...
    private Map<Integer, Boolean> collapsedSections = new HashMap<>();
    private Map<Integer, SectionSelectionState> selectionStateBySection = new HashMap<>();
     ...
     */
    public BasicViewHolder onCreateGhostHeaderViewHolder(ViewGroup parent) {
        View ghostView = new View(parent.getContext());
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        parent.addView(ghostView, layoutParams);
        return new BasicViewHolder(ghostView);
    }
     ...
     */
    public void onBindItemViewHolder(BasicViewHolder viewHolder, int sectionIndex, int itemIndex, int itemUserType) {
    }
     ...
     */
    public void onBindHeaderViewHolder(BasicViewHolder viewHolder, int sectionIndex, int headerUserType) {
    }
     ...
     */
    public void onBindGhostHeaderViewHolder(BasicViewHolder viewHolder, int sectionIndex) {
    }
     ...
     */
    public void onBindFooterViewHolder(BasicViewHolder viewHolder, int sectionIndex, int footerUserType) {
    }
    ...
    /**
     * Mark that all sections are collapsed or not. By default sections are not collapsed and draw
     ...
     */
    protected void collapseAllSections(boolean collapsed) {
        for (int i = 0; i < getNumberOfSections(); i++) {
            setSectionIsCollapsed(i, collapsed);
        }
    }
    ...
    /**
     * Called when a ViewHolder is needed
     *
     * @param parent   The ViewGroup into which the new View will be added after it is bound to an adapter position.
     ...
     */
    public BasicViewHolder onCreateItemViewHolder(ViewGroup parent, int itemType) {
        return null;
    }

    @Override
    public void onBindViewHolder(BasicViewHolder holder, int adapterPosition) {
        ...
        switch (baseType) {
            case TYPE_HEADER:
                onBindHeaderViewHolder(holder, section, userType);
                break;

            case TYPE_ITEM:
                BasicViewHolder ivh = holder;
            ...
            case TYPE_FOOTER:
                onBindFooterViewHolder(holder, section, userType);
                break;

            case TYPE_GHOST_HEADER:
                onBindGhostHeaderViewHolder(holder, section);
                break;
     ...
     */
    void tagViewHolderItemView(BasicViewHolder holder, int section, int adapterPosition) {
