...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
	 ...
	 */
	@Nullable
	public BasicViewHolder getFirstVisibleItemViewHolder(boolean fullyVisibleOnly) {
		return (BasicViewHolder) getFirstVisibleViewHolderOfType(SectioningAdapter.TYPE_ITEM, fullyVisibleOnly);
	}
	 ...
	 */
	@Nullable
	public BasicViewHolder getFirstVisibleHeaderViewHolder(boolean fullyVisibleOnly) {
		return (BasicViewHolder) getFirstVisibleViewHolderOfType(SectioningAdapter.TYPE_HEADER, fullyVisibleOnly);
	}
	 ...
	 */
	@Nullable
	public BasicViewHolder getFirstVisibleFooterViewHolder(boolean fullyVisibleOnly) {
		return (BasicViewHolder) getFirstVisibleViewHolderOfType(SectioningAdapter.TYPE_FOOTER, fullyVisibleOnly);
	}

	@Nullable
	private BasicViewHolder getFirstVisibleViewHolderOfType(int baseType, boolean fullyVisibleOnly) {
		if (getChildCount() == 0) {
			return null;
		}
		...
		if (baseType != SectioningAdapter.TYPE_HEADER) {
			BasicViewHolder firstHeader = getFirstVisibleHeaderViewHolder(false);
			if (firstHeader != null) {
	...
	private BasicViewHolder getViewViewHolder(View view) {
		return (BasicViewHolder) view.getTag(R.id.sectioning_adapter_tag_key_view_viewholder);
	}
